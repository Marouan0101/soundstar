...
const Search = () => {
  ...
  const searchResults = () => {
    if (query === '') {
      ...
      return (
        <div className='absolute left-0 flex space-x-3 rounded-br-xl border border-l-0 border-t-0 border-gray-400/50 bg-slate-50 p-3 dark:bg-dark'>
          {/* Track list */}
              ...
              <div className='space-y-2'>
                {results?.tracks?.items.map((track) => {
                  return (
                    ...
                    >
                      <div
                        className={`relative items-center ${styles.imageAndPlayContainer}`}
                      >
                        <img
                          src='/playIcon.svg'
                        ...
                        />
                        <img
                          className={`${styles.image} h-16 w-16 object-cover`}
          ...
          {results.artists.items.length ? (
            <div className=' border-r border-gray-400/50 pr-3'>
              <div className='mb-2 text-xl font-bold'>Artist</div>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <img
                          src='/playIcon.svg'
                          className={`${styles.playIcon} item-center absolute z-50 m-auto hidden h-12 w-12 translate-x-[89%] translate-y-[19%] cursor-pointer rounded-full border-2 border-transparent p-1 pl-2 hover:border-primary`}
                        />
                        <img
                          className={`${styles.image} m-auto h-16 w-16 rounded-full object-cover`}
