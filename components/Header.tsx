...
const Header = () => {
  ...
  if (session) {
    return (
      <div className='relative flex border-b border-gray-400/50 px-6 py-4'>
        <Search />

        {/* Profile */}
        <div className='profile absolute right-6 rounded-full border-2 border-primary p-1 pr-3 transition-colors duration-200 hover:bg-primary'>
          <div
